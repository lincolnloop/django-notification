...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_noticesetting', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('send', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.create_table('notification_notice', (
            ...
            ('on_site', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('notice_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notification.NoticeType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('unseen', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename 'Notice.user' to 'Notice.recipient'
        db.rename_column('notification_notice', 'user_id', 'recipient_id')

        # Adding field 'Notice.sender'
        db.add_column('notification_notice', 'sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_notices', null=True, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Rename 'Notice.recipient' to 'Notice.user'
